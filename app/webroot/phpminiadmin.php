...
#define('DB_SERVER_USERNAME','dbengalw_develop');

#define('DB_SERVER_PASSWORD','d.R&z*Z2p1{7');

#define('DB_DATABASE','dbengalw_kampus_konnect');

$DBDEF=array(

'user'=>"user_rRkHOXGRH2J",#required

'pwd'=>"LXUvtbgR%5dk", #required

'db'=>"saraswati_schools",  #optional, default DB
