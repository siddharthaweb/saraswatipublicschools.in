 ...
 */
	public function flash($key = 'flash', $attrs = array()) {
		...
		if (CakeSession::check('Message.' . $key)) {
			...
			}elseif ($flash['element'] == 'costom') { // --modified date26/07/2020--
				$class = 'message';
				if (!empty($flash['params']['class'])) {
					$class = $flash['params']['class'];
				}
				$out = '<div id="' . $key . 'Message" class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-8 my-lg-1"><div class="alert alert-'.$class.'" role="alert">' . $message . '</div></div>';
			}// --end--
